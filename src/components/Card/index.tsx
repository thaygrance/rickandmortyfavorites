                    ...
                    <CardContainer key={character.id}>
                        ...
                        <div onClick={() => handleUpdateFavorites(character)}>
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                height= "32"
                                viewBox=" 0 0 24 24"
                                fill={`${favorites.find(favoritesItem => favoritesItem.id 
                                === character.id) ? 'red' : 'none'}`}
                                stroke="currentColor"
                                strokeWidth="2"
                                strokeLinecap="round"
                            ...
                            >
                                ...
                                5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
                            </svg>
                        </div>
                        </ImgDiv>
                        <CardContent>
